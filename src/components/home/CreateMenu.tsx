...
import { UsersRound, UserPlus, FolderKanban, Building2, Megaphone, X } from 'lucide-react-native';
import { colors } from '../../theme';

// Single "Create" hub (Super-Admin only entry point). Every org/admin creation lives here so the
// individual screens no longer carry their own "New …" buttons. Branch creation is intentionally
// absent — branches are attached from the ERP/CRM, not created in this app.
