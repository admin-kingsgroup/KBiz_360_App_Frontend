...
export const adminUsers: User[] = [
  { id: 'a1', name: 'Afshin Dhanani', initials: 'AD', color: '#0C0E14', role: 'SUPER_ADMIN',
    email: 'afshin@kbiz360.com', bizId: null, branches: [], accessGroups: [], accessAlerts: [],
