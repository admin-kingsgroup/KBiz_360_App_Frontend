...
export const PERMISSIONS: PermissionMeta[] = [
  { key: 'location',      iconName: 'navigation', color: '#22C55E', title: 'Location',               desc: 'Detect the office to check in / out. “Allow all the time” also enables auto-punch when the app is closed.' },
