...
export const ROLE_DEFS: Record<RoleKey, RoleDef> = {
  ...
  DIRECTOR: {
    ...
    scope: 'Assigned business · selected branches, groups & alerts',
    sees: 'Sees GM, Branch Mgr, HOD & staff — business-wide',
    perms: ['Oversees assigned business(es)', 'Selected branches & groups', 'Set reminders down the chain', 'Invite GM / Branch Manager / HOD', 'Access only what is granted'],
  },
  GENERAL_MANAGER: {
    key: 'GENERAL_MANAGER', label: 'General Manager', badge: 'GM', color: '#4F8BFF',
    scope: 'Operations · selected branches, groups & alerts',
    sees: 'Sees Branch Mgr, HOD & staff — their branches',
    perms: ['Runs day-to-day operations', 'Selected branches & groups', 'Manage Branch Managers & HODs', 'Set reminders down the chain', 'Access only what is granted'],
  },
  BRANCH_MANAGER: {
    key: 'BRANCH_MANAGER', label: 'Branch Manager', badge: 'BRANCH MGR', color: '#37B6A4',
    scope: 'Selected branches · their groups & alerts',
    sees: 'Sees HOD & staff — their branch',
    perms: ['Manages selected branch(es)', 'All granted groups', 'Manage HODs & staff in scope', 'Set reminders for the branch', 'Cannot see other branches'],
  },
  HOD: {
    key: 'HOD', label: 'HOD', badge: 'HOD', color: '#E8A13A',
    scope: 'Head of Department · selected groups & alerts',
    sees: 'Sees staff — their team',
    perms: ['Heads a team', 'Granted groups & alerts', 'Manage staff in the team', 'Set reminders for the team', 'Access only what is granted'],
  },
  EMPLOYEE: {
    key: 'EMPLOYEE', label: 'Employee', badge: 'EMPLOYEE', color: '#6D6D72',
    scope: 'Own groups & alerts only',
