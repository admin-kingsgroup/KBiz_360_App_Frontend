...
// Branch-qualified grant id, e.g. 'AMD-Accounts' (group) or 'AMD-crm' (alert).
...
export interface User {
  ...
  businessIds?: string[];      // explicit business access grants (company ids, app-side)
  ...
  position?: string | null;    // app-set job title (e.g. "Finance Manager"), distinct from role
